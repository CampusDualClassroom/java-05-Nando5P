...
public class Exercise05 {
    public static void main(String[] args) {
        System.out.println("Funcion checkLessOrGreaterEqual()");
        checkLessOrGreaterEqual(2,6);
        System.out.println("Funcion checkMultiply()");
        checkMultiply(6,3);
        System.out.println("Funcion checkPositiveNegative()");
